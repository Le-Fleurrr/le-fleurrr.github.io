...
const translations = {
  az: {
    ...
    forgotPasswordSubtitle: "Şifrənizi bərpa etmək üçün email ünvanınızı daxil edin",
    sendResetLink: "Bərpa linki göndər",
    resetEmailSent: "Şifrəni bərpa etmək üçün email ünvanınıza keçid göndərildi",
    resetPasswordFailed: "Şifrənin bərpası uğursuz oldu: ",
    userNotFound: "Bu email ilə istifadəçi tapılmadı",
    recaptchaFailed: "Təhlükəsizlik yoxlaması uğursuz oldu. Zəhmət olmasa yenidən cəhd edin.",
  ...
  en: {
    ...
    closeWindow: "Close",
    forgotPasswordLink: "Forgot the password?",
  ...
  ru: {
    ...
    forgotPasswordSubtitle: "Введите email, чтобы получить ссылку для восстановления пароля",
    sendResetLink: "Отправить ссылку",
    resetEmailSent: "Ссылка для восстановления пароля отправлена на вашу почту",
    resetPasswordFailed: "Не удалось восстановить пароль: ",
    userNotFound: "Пользователь с таким email не найден",
    recaptchaFailed: "Проверка безопасности не пройдена. Попробуйте ещё раз.",
