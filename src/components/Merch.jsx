...
const antagoni2tShirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769007842/ANTAGONI2T-Black-T-Shirt-Front_qlw8es.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769007842/ANTAGONI2T-Black-T-Shirt-Back_gkbf15.png"]
};

const antagonistWhiteShirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769007852/Antagonist-Tour-2.0-White-Tour-T_oqjlaw.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769007852/Antagonist-Tour-2.0-White-Tour-T2_n9wesl.png"]
};

const antagonistStarShirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769007850/Antagonist-Tour-2.0-Star-T-Shirt_hxma6k.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769007852/Antagonist-Tour-2.0-Star-T-Shirt1_x8wila.png"]
};

const antagonist00Shirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769008318/front_191506e9-1401-40c1-9dd7-12_vqzumb.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769008314/back_6722dc23-c171-44da-a0b0-78e_nptqme.png"]
};

const antagonistOpiumShirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769008335/Opium-Antagonist-Tour-2.0-T-Shirt_xfz5h4.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769008334/Opium-Antagonist-Tour-2.0-T-Shir_onzpbw.png"]
};

const antagonistOpiumLongSleeve = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769008329/Opium-Antagonist-Tour-2.0-Long-S_j6c1ks.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769008329/Opium-Antagonist-Tour-2.0-Long-S1_yzwx8p.png"]
};

const antagonistRedDaggerHoodie = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769008007/AntagonistTourRedDaggerHoodieFro_wnjfzu.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769008002/AntagonistTourRedDaggerHoodieBack_tx1tdq.png"]
};

const antagonistExplicitSweatpants = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769007843/AntagonistTour2.0ExplicitSweatpants_y7d0s8.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769007843/AntagonistTour2.0ExplicitSweatpants1_phgiis.png"]
};

const antagonistVol2Shirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769008316/front_1f23f4cf-6822-493f-82a4-73_nutyst.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769008315/back_ddf4a66c-93cb-4873-9b8e-617_upx1rq.png"]
};

const antagonistZipUp = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769008317/Front_a7dce85e-cf5e-42ed-a9de-e8_xdvy3p.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769008315/Back_3e0aec91-46a8-40b5-a6a9-b50_hgdyzd.png"]
};

const antagonistBlackShirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769008328/front_cbeb5d83-2c02-4a3c-814f-7a_ausy6n.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769008315/back_42b409db-7d69-4902-adb9-a7a_rw3n2b.png"]
};

const antagonistBlackHoodie = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769007844/AntagonistTour2.0BlackHoodieFron_i4jikf.png",
...
const MCXSHorts = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769010711/KCXAHSHORTS_FRONT_x8t2lp.png",
};

const bh3BabyShirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769010674/BH3_Baby_T-Shirt_qtcyq7.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769010674/3_Baby_T-Shirt_Back_mu77rf.png"]
};

const bh3PiercingsGirlShirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769010699/PiercingGirl_3T-Shirt_ybjffq.png",
  additionalImages: ["https://res.cloudinary.com/deroy68n9/image/upload/v1769010699/PiercingGirl_3T-Shirt_Back_zy6c7h.png"]
};

const bh3PoemShirt = {
  front: "https://res.cloudinary.com/deroy68n9/image/upload/v1769010701/Top_Floor_Boss_Poem_T-Shirt_Fron_rk8hpm.png",
...
export const MerchCategories = [
  {
    name: "Antagonist 2.0",
    banner: "https://res.cloudinary.com/deroy68n9/image/upload/v1768919988/antagonist2.0_Logo_mbxh8k.png",
    isExplicit: true
  },
];
...
export const Merch = [
  ...
  },
  {
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: antagonistDoubleZip.front,
    additionalImages: antagonistDoubleZip.additionalImages,
    color: "Qara",
    description: "Qabırğalı toxunmuş ikiqat fermuarlı kapşonlu köynək. Uyğun siluetlə dizayn edilmişdir. Ekran çaplı qrafika. -Qabırğalı toxunmuş parça. -Bərkitilmiş kapşonlu. -İkiqat fermuarlı ön bağlama. -Qısa uzunluq.",
  },
  {
    id: 4,
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: antagoni2tShirt.front,
    additionalImages: antagoni2tShirt.additionalImages,
    color: "Qara",
    description: "Ekran çaplı qrafikalı ağır çəkili futbolka.",
  },
  /*{
    id: 65354353531,
    title: "ANTAGONI2T 2.0 AG TUR FUTBOLKA",
    artist: ["Playboi Carti"],
    category: "Antagonist 2.0",
    price: 150,
    year: 2025,
    isNew: true,
    size: ["S", "M", "L", "XL"],
    image: antagonistWhiteShirt.front,
    additionalImages: antagonistWhiteShirt.additionalImages,
    color: "Ag",
    description: "Ekran çaplı qrafikalı ağır çəkili futbolka.",
    material: "100% Cotton"
  },*/
  {
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: antagonistStarShirt.front,
    additionalImages: antagonistStarShirt.additionalImages,
    color: "Qara",
    description: "Ekran çaplı qrafikalı ağır çəkili futbolka.",
  },
  {
  ...
  },
  {
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: antagonistRedDaggerHoodie.front,
    additionalImages: antagonistRedDaggerHoodie.additionalImages,
    color: "Qırmızı",
    description: "Ekran üzərində çap olunmuş qrafikalı, ağır çəkili uzunqollu köynək.",
  },
  {
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: antagonistExplicitSweatpants.front,
    additionalImages: antagonistExplicitSweatpants.additionalImages,
    color: "Qara",
  ...
  },
  {
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: antagonistVol2Shirt.front,
    additionalImages: antagonistVol2Shirt.additionalImages,
    color: "Qara",
    description: "Ekran çaplı qrafikalı ağır çəkili futbolka.",
  },
  {
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: antagonistZipUp.front,
    additionalImages: antagonistZipUp.additionalImages,
    color: "Qara",
  ...
  },
  {
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: antagonistBlackShirt.front,
    additionalImages: antagonistBlackShirt.additionalImages,
    color: "Qara",
    description: "Ekran çaplı qrafikalı ağır çəkili futbolka.",
  },
  {
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: antagonistBlackHoodie.front,
  ...
  },
  {
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL"],
    image: MCXSHorts.front,
    color: "Qara",
    description: "Qırışlı yük şortu - ABŞ-da istehsal olunub, orta çəkili qara rəngli fransız terrisi - Genişləndirilmiş ciblər - Xaricə doğru orta baldır silueti - Hər tərəfə əl ilə yazılmış trafaret",
  },
  {
    id: 24,
    ...
    image: bh3BabyShirt.front,
    additionalImages: bh3BabyShirt.additionalImages,
    color: "Qara",
    description: "Daranmış pambıq körpə qabırğa futbolkası. Orijinal ölçüsündən 2 dəfəyə qədər uzanır.",
  },
  {
    id: 25,
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL", "3XL"],
    image: bh3PiercingsGirlShirt.front,
    additionalImages: bh3PiercingsGirlShirt.additionalImages,
    color: "Ağ",
    description: "Ekran çaplı qrafika və rhinestones ilə böyüdülmüş futbolka. Əsl forma üçün ölçüsü kiçildilib.",
  },
  {
    id: 26,
    ...
    isNew: true,
    size: ["S", "M", "L", "XL", "2XL", "3XL"],
    image: bh3WitchLongSleeve.front,
    additionalImages: bh3WitchLongSleeve.additionalImages,
    color: "Qara",
